...
export enum AzureResource {
  ...
  // ── Renamed subtypes (verified against Go source) ──────────────────
  AutomationVariableBool = 'azurerm_automation_variable_bool',
  AutomationVariableInt = 'azurerm_automation_variable_int',
  AutomationVariableString = 'azurerm_automation_variable_string',
  ManagementGroupPolicyAssignment = 'azurerm_management_group_policy_assignment',
  ManagementGroupPolicyExemption = 'azurerm_management_group_policy_exemption',
  MonitorMetricAlert = 'azurerm_monitor_metric_alert',
  ResourceGroupPolicyAssignment = 'azurerm_resource_group_policy_assignment',
  ResourceGroupPolicyExemption = 'azurerm_resource_group_policy_exemption',
  ResourcePolicyAssignment = 'azurerm_resource_policy_assignment',
  ResourcePolicyExemption = 'azurerm_resource_policy_exemption',
  ...
  SignalrSharedPrivateLinkResource = 'azurerm_signalr_shared_private_link_resource',
  StreamAnalyticsReferenceInputBlob = 'azurerm_stream_analytics_reference_input_blob',
  SubscriptionPolicyAssignment = 'azurerm_subscription_policy_assignment',
  SubscriptionPolicyExemption = 'azurerm_subscription_policy_exemption',
  TrafficManagerAzureEndpoint = 'azurerm_traffic_manager_azure_endpoint',
  TrafficManagerExternalEndpoint = 'azurerm_traffic_manager_external_endpoint',
  TrafficManagerGeographicalLocation = 'azurerm_traffic_manager_geographical_location',
  TrafficManagerNestedEndpoint = 'azurerm_traffic_manager_nested_endpoint',
}
