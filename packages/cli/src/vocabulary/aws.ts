...
export enum AwsResource {
  ...
  EksAccessEntry = 'aws_eks_access_entry',
  EksAccessPolicyAssociation = 'aws_eks_access_policy_association',
  Lb = 'aws_lb',
  ...
  DbOptionGroup = 'aws_db_option_group',
  ...
  AutoscalingTrafficSourceAttachment = 'aws_autoscaling_traffic_source_attachment',
  ...
  ElasticacheGlobalReplicationGroup = 'aws_elasticache_global_replication_group',
  ElasticacheServerlessCache = 'aws_elasticache_serverless_cache',
  ...
  OpensearchPackageAssociation = 'aws_opensearch_package_association',
  OpensearchVpcEndpoint = 'aws_opensearch_vpc_endpoint',
  OpensearchserverlessCollection = 'aws_opensearchserverless_collection',
  OpensearchserverlessSecurityPolicy = 'aws_opensearchserverless_security_policy',
  OpensearchserverlessSecurityConfig = 'aws_opensearchserverless_security_config',
  OpensearchserverlessAccessPolicy = 'aws_opensearchserverless_access_policy',
  OpensearchserverlessLifecyclePolicy = 'aws_opensearchserverless_lifecycle_policy',
  OpensearchserverlessVpcEndpoint = 'aws_opensearchserverless_vpc_endpoint',
